...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li><a href="Admin_Applicants.php"><i class="fa-solid fa-user-check"></i> Applicants</a></li>
            <li class="active"><a href="Admin_Requests.php"><i class="fa-solid fa-file-invoice"></i> Requests</a></li>
