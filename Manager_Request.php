...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="nav">
      ...
      <li class="active"><a href="Manager_Request.php"><i class="fa-solid fa-code-pull-request"></i>Requests</a></li>
  ...
  <div class="main-content">
    <div class="request-header">
      <h1><i class="fa-solid fa-person-circle-check"></i> Employee Requests</h1>
